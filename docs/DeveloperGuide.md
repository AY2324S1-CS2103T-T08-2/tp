...
| `* *`    | user                    | undo/redo previous commands that modified the list of stored/displayed contacts in NetworkBook | easily revert mistaken/temporary actions to stored/displayed contacts and/or reapply them if needed |
